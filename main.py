...
app = FastAPI(title='Backstract Generated APIs - agitated-aarav-f4f8824132', debug=False,
              docs_url='/ap-southeast-2-backstractelb-f35a53-coll-7f2307a9909a4545963f38484a998420/docs',
              openapi_url='/ap-southeast-2-backstractelb-f35a53-coll-7f2307a9909a4545963f38484a998420/openapi.json',
              root_path='')
...
app.include_router(
    router,
    prefix='/ap-southeast-2-backstractelb-f35a53-coll-7f2307a9909a4545963f38484a998420/api',
    tags=['APIs v1']
)
